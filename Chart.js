...
window.dailyShamePool = [
  ...
  { k: "shame", cond: (d) => d.todayGames >= 2 && d.todayWins === 0 && d.todayRest > 8, i: "🌧️", t: "Regentanz", d: ["Trübe Aussichten am Tisch.", "Ein verregneter Nachmittag.", "Nichts glänzt heute.", "Er braucht einen Regenschirm für die Tränen.", "Ein Tiefdruckgebiet am Queue.", "Warten auf die Sonne."], h: "Spiel heute mind. 2 Matches, gewinne keins und lass insgesamt 8+ Kugeln liegen"},
